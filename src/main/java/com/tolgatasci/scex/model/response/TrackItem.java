...
import com.tolgatasci.scex.model.response.seach.Media;
import com.tolgatasci.scex.model.response.seach.PublisherMetadata;
import com.tolgatasci.scex.model.response.seach.User;
...
public class TrackItem {
    ...
    private com.tolgatasci.scex.model.response.seach.Media media;
    ...
    @SerializedName("user")
    private com.tolgatasci.scex.model.response.seach.User user;
