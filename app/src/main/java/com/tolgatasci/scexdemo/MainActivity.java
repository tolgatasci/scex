...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yt.Doc("https://api-v2.soundcloud.com/media/soundcloud:tracks:186613464/6b49f818-be4d-459d-8cfa-5371768459ba/stream/progressive", (CallbackApi.ResData<ResponseDoc>) response -> Log.e("work",response.getUrl() + ""));
    }
}